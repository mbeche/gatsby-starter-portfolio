    ...
    return (
      <React.Fragment>
        <Helmet>
          ...
          <meta
            name="twitter:title"
            content="Dev Portfolio - Michael Johnson"
          />
          <meta
        ...
        <Page>
          ...
          <SliderWrapper>
            ...
            <Grid>
              {edges
                .filter(site => site.node.type === "independent")
                .map(site => {
                  console.log(site);
                  const {
                    id,
          ...
          <SliderWrapper>
            ...
            <Grid>
              {edges
                .filter(site => site.node.type === "learning")
                .map(site => {
                  const {
                    id,
                    title,
          ...
          <Footer>
            <p>
              Design by{" "}
              <OutboundLink href="https://www.lekoarts.de">
                LekoArts
              </OutboundLink>
              .{" "}
              <OutboundLink href="https://github.com/LeKoArts/gatsby-starter-portfolio">
                Source
              </OutboundLink>
              .
            </p>
            ...
            <p>
              <OutboundLink href="https://github.com/mbeche/gatsby-starter-portfolio">
                Source
              </OutboundLink>
              .
            </p>
